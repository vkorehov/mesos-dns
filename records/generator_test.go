...
func TestInsertState(t *testing.T) {
	...
	for i, tt := range []struct {
		...
		{rg.As, "A", "container.liquor-store.marathon.mesos.", []string{"10.3.0.1", "10.3.0.2"}},
		{rg.As, "A", "container.reviewbot.marathon.mesos.", []string{"10.5.0.7"}},
		{rg.As, "A", "poseidon.marathon.mesos.", nil},
		{rg.As, "A", "container.poseidon.marathon.mesos.", nil},
